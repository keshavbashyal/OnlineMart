<%-- 
    Document   : listwomen
    Created on : Dec 30, 2014, 10:10:06 PM
    Author     : Keshav
--%>
...
<!-- Mirrored from wbpreview.com/previews/WB0096211/listwomen.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Dec 2014 03:23:53 GMT -->
<head>
		<meta charset="utf-8">
...
<header>
		...
		<div class="container" id="main-content">
			<div class="row">
			<div class="listimage">
			<img src="img/sample/catimage.jpg" alt="" class="pull-left" />
			<div class="cattitle">
			Women's Dresses
			</div>
			</div>
